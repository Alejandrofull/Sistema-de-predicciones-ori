...
def training_completed(*, training_id: int, model_name: str, recipient_role: str = "general_admin", metrics: dict | None = None, duration_seconds: float | None = None) -> Notification:
